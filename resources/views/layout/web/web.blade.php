...
<head>
    ...
    <!-- Theme CSS -->
    <link href="{{ asset('asset/web/css/freelancer.min.css') }}" rel="stylesheet">
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="{{ route('homepage') }}">HOMEPAGE</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item mx-0 mx-lg-1">
                        <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="http://127.0.0.1:8000/contact">Contact Us</a>
                    </li>
                    <li class="nav-item mx-0 mx-lg-1">
                        <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="http://127.0.0.1:8000/about">About Us</a>
                    </li>
                    @if(Auth::check())
                    <li class="nav-item mx-0 mx-lg-1">
    ...
    <script src="{{asset('asset/web/vendor/jquery/jquery.min.js')}}"></script>
    <script src="{{asset('asset/web/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>

    <!-- Plugin JavaScript -->
    <script src="{{asset('asset/web/vendor/jquery-easing/jquery.easing.min.js')}}"></script>

    <!-- Contact Form JavaScript -->
    <script src="{{asset('asset/web/js/jqBootstrapValidation.js')}}"></script>
    <script src="{{asset('asset/web/js/contact_me.js')}}"></script>

    <!-- Custom scripts for this template -->
    <script src="{{asset('asset/web/js/freelancer.min.js')}}"></script>
